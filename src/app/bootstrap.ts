...
export class Bootstrap {
    ...
    picada: Gasto = new Gasto({ producto: "picada", monto_total: 400, moneda: this.peso, tags: [this.chino], fecha: new Date("7 July 2019") })
    weird: Gasto = new Gasto({ producto: "raro", monto_total: 765, moneda: this.dolar, tags: [this.chino, this.sube], fecha: new Date("27 July 2019") })
